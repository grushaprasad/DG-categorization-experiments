...
#         fname = 'list%s_dg%s_%s_%s.wav'%(l, re.findall('\d+', dg_stims[i][1])[0], i+1, item[1])
#         fpath = './combined_stims/mturk/wav/%s'%fname
#         #fpath = './tmp2/%s'%fname
...
# practice_precursors = [('lowmid', lowmid), ('midlow',midlow), ('midhigh',midhigh), ('highmid',highmid)]
...
#     fpath = './combined_stims/mturk/%s'%fname
#     #fpath = './tmp/%s'%fname
