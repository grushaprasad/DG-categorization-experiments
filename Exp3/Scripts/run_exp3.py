...
dataFilename = '../data/DGcontext_Exp2%s.csv'%part_id

stimFile_block1 = 'exp3_block1_stimlist.csv'
stimFile_block2 = 'exp3_block2_stimlist.csv'
stimFile_practice1 = 'exp3_practice1_stimlist.csv'
stimFile_practice2 = 'exp3_practice2_stimlist.csv'
...
def runTrial(trial, trial_id, block=1, practice = False):
    ...
    if block == 1:
        trial_info = [part_id, stim, 'block1', practice, trial_id, response]
    else:
        trial_info = [part_id, fname, cond, practice,trial_id, response]
...
trial_instructions = "If you hear a \"d\" at the beginning of the syllable, press the yellow key. If you hear a \"g\" at the beginning of the syllable, press the blue key. "


message.setText("Welcome! There are two parts to this experiment. In the first part, you will hear a syllable and decide what consonant it begins with. If you hear a \"d\" at the beginning of the syllable, press the yellow key (on the left). If you hear a \"g\", press the blue key (on the right).\n\n\
The second part of the experiment works exactly the same way, except that you will hear a short sequence of tones prior to each syllable. (You will still decide whether the beginning consonant is \"d\" or \"g\").")
